...
Populate the  `@dbAlias` parmeter with a name that will be used throughout CDCX objects when referring to the database containing CDC objects you want CDCX to help you with. 
...
Populate the  `@cdcDbName` parmeter with the name of the cdc-enabled database to which you want to refer.
