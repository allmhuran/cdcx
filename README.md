...
`@dbAlias` : 
    ...
    This alias is used throughout CDCX objects to ensure consistent object names even if your CDC enabled database has different names in different environments, or even if you want to track the same database in which you        ran  cdcx_setup.sql.

`@cdcDbName` : 
    The name of the cdc-enabled database to which you want to refer.<br/>
